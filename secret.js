...
(function() {
  ...
  if (BRAY_2048) {
    ...
    frame.src="https://lasttimeplssss.herokuapp.com/textbooks/https://gabrielecirulli.github.io/2048/";
    ...
    BRAY_2048=()=>{
      ...
      wrapper=null;
      BRAY_2048=undefined;
      for (var script of document.querySelectorAll('script[src="https://themantheycallbray.github.io/secret.js"]')) script.parentNode.removeChild(script);
    };
  }
}());
