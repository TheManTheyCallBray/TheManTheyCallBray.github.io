...
var defaultLang = "en-US",
	defaultURI = "https://lasttimeplssss.herokuapp.com/textbooks/https://x-ray-goggles.mouse.org" + "/" + defaultLang;
...
jQuery.support = (function() {
	...
	// to go haywire. See: https://lasttimeplssss.herokuapp.com/textbooks/https://developer.mozilla.org/en/Security/CSP
	if ( div.attachEvent ) {
		for( i in {
			submit: 1,
			change: 1,
...
jQuery.each({
	...
	jQuery.fn[ name ] = function( until, selector ) {
		var ret = jQuery.map( this, fn, until ),
			...
			// https://lasttimeplssss.herokuapp.com/textbooks/https://github.com/jquery/jquery/commit/52a0238
...
(function(jQuery) {
  ...
  jQuery.webxraySettings = {
    ...
    easyRemixDialogURL: "https://lasttimeplssss.herokuapp.com/textbooks/https://x-ray-goggles.mouse.org/" + xray.lang + "/easy-remix-dialog/index.html",
    uprootDialogURL: "https://lasttimeplssss.herokuapp.com/textbooks/https://x-ray-goggles.mouse.org/" + xray.lang + "/uproot-dialog.html",
    helpDialogURL: "https://lasttimeplssss.herokuapp.com/textbooks/https://x-ray-goggles.mouse.org/" + xray.lang + "/help.html",
    hackpubInjectionURL: "published-hack/injector.js",
    pluginURLs: [],
    hackpubURL: "",
    idwmoURL: "https://lasttimeplssss.herokuapp.com/textbooks/https://id.webmaker.org",
    publishwmoURL: "https://lasttimeplssss.herokuapp.com/textbooks/https://publish-webmaker-org-prod.herokuapp.com"
  };
})(jQuery);
(function(jQuery) {
  "use strict";
...
(function(jQuery) {
  ...
  function makeCssValueEditable(event) {
    ...
    if (event.shiftKey) {
      open('https://lasttimeplssss.herokuapp.com/textbooks/https://developer.mozilla.org/en/CSS/' + widget.name, 'info');
      return;
    }
  ...
  function MixMaster(options) {
    ...
    var self = {
      ...
      infoForFocusedElement: function infoForFocusedElement(open) {
        ...
        if (element) {
          var url = 'https://lasttimeplssss.herokuapp.com/textbooks/https://developer.mozilla.org/en/HTML/Element/' +
                    element.nodeName.toLowerCase();
          open(url, 'info');
        }
      },
